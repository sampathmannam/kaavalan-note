...
The v2.5.0 release-candidate gates, original-certificate signing and signed in-place upgrade/persistence check subsequently passed. See [release verification](development/v2.5.0-release-verification.md). This additional release evidence does not relabel the earlier code-50 debug test runs as tests of the signed artifact.
