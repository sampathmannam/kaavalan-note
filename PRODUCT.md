...
2. Write, speak or photograph a note from any working tab. Responsibility defaults to **For me**; **Assigned by me** and **Received** are explicit choices. A **For me** instruction may separately record who assigned it, using a quick senior-officer designation, a name, or a saved contact.
...
5. Edit saved instruction text, responsibility, responsible/related contact, assigning officer and deadline. The deadline describes when work must finish; the follow-up controls when the officer is reminded. Neither date overwrites the other. Completion offers immediate Undo; closed records remain searchable and can be reopened.
